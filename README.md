...
## 分享群
开了一个分享群，有兴趣可以加入，如果你有关于 workflow 的问题也可以一起讨论。（2025/04/07 更新）
...
| 文件             | 描述                                                         | 来源                                               |
| ---------------- | ------------------------------------------------------------ | -------------------------------------------------- |
| `代码机器人.yml` | ![高效准确的代码撰写机器人-需求转换为需求文档加代码](./images/Dify_Code_Assistant_example.png) | [@Formyselfonly](https://github.com/Formyselfonly) |
